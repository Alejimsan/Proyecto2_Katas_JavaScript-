// 1. 1. Luke Skywalker cumple años: Modifica el siguiente código JavaScript para actualizar la edad de Luke Skywalker a 25 años.

const jedi = {nombre: "Luke Skywalker", edad: 19};

jedi.edad = 25 // Tu código para cambiar la edad aquí... 
...
console.log(`El precio de los dos sables de luz es ${precioTotal}.`) // Tu código para calcular el precio total aquí...
...
precioBaseGlobal = 25000; // Cambia el precio base modificando la variable
...
console.log(`El precio final de la nave ${nave1.nombre} es de ${nave1.precioFinal}`);
console.log(`El precio final de la nave ${nave2.nombre} es de ${nave2.precioFinal}`);